...
export default async function DashboardPage() {
  ...
  //server action to destroy a note
  ...
  return (
    <div className="grid items-start gap-y-8">
      <div className="flex items-center justify-between px-2">
        <div className="grid gap-1">
          ...
          <p className="text-lg text-muted-foreground">
            Here you can see & create new notes
          </p>
        </div>
      ...
      {data?.Notes.length == 0 ? (
        <div className="flex min-h-[400px] flex-col items-center justify-center rounded-md border border-dash p-8 text-center animate-in fade-in-50">
